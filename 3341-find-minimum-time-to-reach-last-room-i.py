"""
Level: Medium
Link: https://leetcode.com/find-minimum-time-to-reach-last-room-i/
...
class Solution:
    def minTimeToReach(self, moveTime: list[list[int]]) -> int:
        ...
        dcol = [0, 0, -1, 1]
        while queue:
            cur_cell_time, row, col = heapq.heappop(queue)
